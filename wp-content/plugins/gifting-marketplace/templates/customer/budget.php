...
<div class="gm-modal-overlay" id="gm-occ-modal" role="dialog" aria-modal="true">
    <div class="gm-modal">
        ...
        <div class="gm-modal__body">
            ...
            <div class="gm-form-row">
                <label class="gm-form-label" for="gm-occ-items">Number of Items</label>
                <input type="number" id="gm-occ-items" class="gm-form-input"
                       placeholder="e.g. 50" min="0" step="1" style="max-width:200px" />
                <p class="gm-form-hint" style="margin-top:4px">Optional — how many gifts you plan to buy</p>
            </div>
            <div class="gm-form-row">
