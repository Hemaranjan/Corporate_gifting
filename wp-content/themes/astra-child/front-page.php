    ...
    <div class="gmp-container">
        ...
        <div class="gmp-steps">
            ...
            <div class="gmp-step">
                ...
                <div class="gmp-step__icon">🎁</div>
                <h3>Browse &amp; Order</h3>
                <p>Browse curated B2B gift catalogues and place orders directly from verified vendors.</p>
            </div>
            <div class="gmp-step__arrow">→</div>
            <div class="gmp-step">
    ...
    <div class="gmp-container">
        ...
        <div class="gmp-why-grid">
            <div class="gmp-why-card">
                ...
                <p>Every vendor on Giftelier is verified and specialised — find the right gifting partner for your industry and occasion.</p>
            </div>
            <div class="gmp-why-card">
                <div class="gmp-why-card__icon">📅</div>
